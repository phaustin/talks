...
#
# (ii) Subjective interpretation: the forecaster's judgement is that the odds against
...
# ## Maximum likelihood
#
# Solve this for the set of parameters that give the **maximum likelihood** by taking the $\log$ and finding the maximum by setting the derivitive = 0 and solving for $(\theta_0, \theta_1, \sigma)$.  This gives you the usual relationship for the slope and intercept in terms of the data statistics ($\overline{x}$,$\overline{y}$)
#
# $$
...
# %% {"slideshow": {"slide_type": "subslide"}, "scrolled": true}
